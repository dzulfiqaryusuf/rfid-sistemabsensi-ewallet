...
<div class="container-fluid" style="text-align: center; font-family: 'Orbitron', sans-serif; ">
	<?php if($nokartu=="") { ?>

	<h3>Absen : <?php echo $mode; ?> </h3>
	<h3>Silahkan Tempelkan Kartu RFID Anda</h3>
	<img src="images/rfidw.png" style="width: 200px"> <br>
	<img src="images/animasi99.gif">
